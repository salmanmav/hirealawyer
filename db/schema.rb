...
ActiveRecord::Schema.define(version: 20170214155319) do
  ...
  create_table "cases", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.index ["lawyer_id"], name: "index_cases_on_lawyer_id", using: :btree
  end
  ...
  create_table "lawyers", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string   "name"
    t.string   "email"
